...
from profiles2.models import company_ent, funding_ent, acquisition_ent, member_ent
from profiles2 import classes
...
def company_list(request):
     ...
     t = get_template('company_list2.html')
